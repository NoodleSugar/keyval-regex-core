...
import insomnia.implem.kv.pregex.fpa.PRegexVMFPA.Type;
import insomnia.implem.kv.pregex.Quantifier;

public class PRegexVMFPABuilder
{
	...
	public PRegexVMFPABuilder(IPRegexElement elements)
	{
	...
	public PRegexVMFPA<KVValue, KVLabel> build()
	{
		return new PRegexVMFPA<>(this);
	}
}
