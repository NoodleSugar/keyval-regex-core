...
import insomnia.implem.fsa.fpa.graphchunk.GCStates;
...
import insomnia.implem.kv.fsa.fpa.KVGraphChunkModifier;
 ...
 * @param <E>
 */
public class PRegexFPAFactory<VAL, LBL>
{
	...
	public PRegexFPAFactory(IPRegexElement elements, IFSALabelFactory<LBL> labelFactory)// throws BuilderException
	{
	 ...
	 * @param path
	 */
	public PRegexFPAFactory(IPath<VAL, LBL> path)
	{
	 ...
	 * @return
	 */
	public PRegexFPAFactory<VAL, LBL> setGraphChunkModifier(KVGraphChunkModifier<VAL, LBL> graphChunkModifier)
	{
	...
	public PRegexFPAFactory<VAL, LBL> mustBeSync(boolean val)
	{
		mustBeSync = val;
		return this;
	}
