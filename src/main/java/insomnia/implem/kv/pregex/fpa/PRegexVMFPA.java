...
import insomnia.implem.kv.pregex.fpa.PRegexVMFPABuilder.InstructionData;
import insomnia.fsa.fpa.IFPA;

public class PRegexVMFPA<V, E> implements IFPA<V, E>
{
	protected enum Type
	{
	...
	protected PRegexVMFPA(PRegexVMFPABuilder builder)
	{
	...
	@Override
	public boolean test(IFPAPath<V, E> element)
	{
