...
public class PRegexFSAFactory<VAL, LBL>
{
	...
	public PRegexFSAFactory(IPRegexElement elements, ILabelFactory<LBL> labelFactory)// throws BuilderException
	{
	...
	private GChunk recursiveConstruct(IPRegexElement element, ILabelFactory<LBL> labelFactory)// throws BuilderException
	{
